...
from niveles import NIVELES, NIVEL_FINAL
...
def main():
    ...
    # ── Estado global ─────────────────────────────────────
    estado = "menu"          # estado actual de la máquina
    nivel_idx = 0            # índice en NIVELES[]
    pantalla_actual = None   # instancia de la pantalla activa
            ...
            if estado == "menu":
                ...
                if resultado == "siguiente":
                    ...
                    if nivel_idx < len(NIVELES):
                        ...
                        # Nivel final: narrativa del reporte
                        ir_a("narrativa")

            elif estado == "reporte":
                if resultado == "menu":
                    arbol.__init__()  # reiniciar árbol
                    nivel_idx = 0
                    ir_a("menu")
